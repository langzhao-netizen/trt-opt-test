...
if [ ! -x "$GENERATE_SCRIPT" ]; then
    echo "Error: run_ptq_single.sh not found or not executable" >&2
    exit 1
fi
...
# Do not delete existing saved_models_*_kv_none; skip or overwrite per Model Optimizer behavior.
